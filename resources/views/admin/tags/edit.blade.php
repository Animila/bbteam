        ...
        <div class="content-wrapper bg-black">
            <section class="content">
                <div class="container bg-dark p-2">
                    <form action="{{route('tags.update', $content['tag']->id)}}"  method="post" enctype="multipart/form-data" id="userSetting">
                        @csrf
                        @method('patch')
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control bg-black" type="text" placeholder="(необязательно)" name="title" value="{{$content['tag']->title}}" id="nick">

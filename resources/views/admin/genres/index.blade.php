            ...
            <section class="content bg-black">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-4 align-content-center mb-6"><a class="btn btn-block btn-danger btn-lg" href="{{route('genres.create')}}" type="button">Добавить</a></div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-nohover text-nowrap bg-dark">
                                        ...
                                        <tbody>
                                        @foreach($content['genre'] as $genre)
                                            <tr>
                                                <td>{{$genre->id}}</td>
                                                <td>{{$genre->title}}</td>

                                                <td class="d-flex justify-content-evenly">
                                                    <a class="btn nohover bg-dark" href="{{route('genres.edit', $genre->id)}}"><i class="fas fa-edit"></i></a>
